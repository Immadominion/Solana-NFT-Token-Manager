...
class _DashboardChartState extends State<DashboardChart> {
  ...
  Widget bottomTitles(double value, TitleMeta meta) {
    TextStyle style =
        TextStyle(color: AlbumsColors.darkGreyColor, fontSize: 10);
    String text;
    switch (value.toInt()) {
      case 0:
        text = AlbumString.jan;
        break;
      case 1:
        text = AlbumString.feb;
        break;
      case 2:
        text = AlbumString.mar;
        break;
      case 3:
        text = AlbumString.apr;
        break;
      case 4:
        text = AlbumString.may;
        break;
      case 5:
        text = AlbumString.jun;
        break;
      case 6:
        text = AlbumString.jul;
      case 7:
        text = AlbumString.aug;
      case 8:
        text = AlbumString.sep;
      case 9:
        text = AlbumString.oct;
      case 10:
        text = AlbumString.nov;
      case 11:
        text = AlbumString.dec;
        break;
      default:
        text = '';
        break;
    ...
    return BarChartGroupData(
      ...
      barRods: [
        BarChartRodData(
          ...
          gradient: isTouched
              ? LinearGradient(
                  colors: AlbumsColors.containerGradient,
                  begin: Alignment.topCenter,
                  end: Alignment.bottomCenter,
                )
              : LinearGradient(colors: [
                  AlbumsColors.primaryColorTransp,
                  AlbumsColors.primaryColorTransp
                ]),
          ...
          BarChartData(
            ...
            barTouchData: BarTouchData(
              ...
              touchTooltipData: BarTouchTooltipData(
                tooltipBgColor: AlbumsColors.secondaryColor,
              ),
